...
{//old ds cooktorrrance
	Properties
	{
		...
		_RoughnessX("_RoughnessX",Range(0,1.0)) = 0.0
		_RoughnessY("_RoughnessY",Range(0,1.0)) = 0.0
	...
	SubShader
	{
		...
		//		shadowproj.y *= -1;
			...
			//	i.view_pos_nor.z=-i.view_pos_nor.z;//因为camera是左手坐标系，unity的obj是右手坐标系。
				...
				PBRAniso(roughness, -lightdir.xyz, e, normal, diff, spec,i.tangent, _RoughnessX, _RoughnessY);
